...
export const analyzeScript = async (scriptParts: string[], targetSceneCount: number): Promise<AnalysisResult> => {
  ...
  **VEO 3 VIDEO PROMPT RULES (CRITICAL):**
  ...
  - **Structure (Korean)**: "[Camera Movement]. [Lighting/Atmosphere]. [Action/Emotion]. [Details]."
      ...
      characters: {
        ...
        items: {
          ...
          properties: {
            ...
            description: { type: Type.STRING, description: "Detailed physical appearance strictly in KOREAN (한국어)." }
          },
      ...
      scenes: {
        ...
        items: {
          ...
          properties: {
            ...
            videoPrompt: { type: Type.STRING, description: "Cinematic Video prompt in KOREAN. Make Scene #1 (Intro) very intense and natural." }
          },
