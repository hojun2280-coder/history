                                ...
                                <div className="flex border-b border-gray-700 mb-0 overflow-x-auto">
                                    {scriptParts.map((_, index) => (
                                        <button
                                            ...
                                            className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${activePartIndex === index
                        ...
                        <div className="w-full md:w-96 bg-gray-800 flex flex-col border-l border-gray-700">
                            <div className="p-6 flex-1 overflow-y-auto custom-scrollbar">
                                ...
                                {selectedItem.type === 'scene' && (
                                    <div className="mb-6">
                                        <span className="text-xs font-bold text-pink-400 uppercase tracking-wider mb-1 block">Veo Video Prompt (English)</span>
